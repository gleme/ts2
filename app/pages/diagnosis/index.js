...
import { findByCode, findByDiasease } from '../../services/consultation/diagnosis';
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <Divider />
        {!diagnosis && !results && (
          <img src="../static/images/doctor.png" style={{ display: 'block', margin: '0 auto' }} />
        )}
        {loading && <LoadingSpinner />}
        {!loading && type === 1 && diagnosis && <DiagnosisDetails diagnosis={diagnosis} />}
        {!loading && type === 2 && results && <DiagnosisList results={results} />}
      </Fragment>
    );
  }
}
